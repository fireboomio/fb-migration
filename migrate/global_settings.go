...
func migrateGlobalSettings() {
	...
	//反序列化
	var globalConfig = origin.GlobalConfig{}
	json.Unmarshal(content1, &globalConfig)
	var globalSystemConfig = origin.Setting{}
	json.Unmarshal(content2, &globalSystemConfig)
...
// 将[]string转变为[]*wgpb.ConfigurationVariable
